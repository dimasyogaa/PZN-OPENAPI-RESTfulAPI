...
import io.swagger.server.apis.AllApi
import io.swagger.server.apis.TodolistApi
...
fun Application.main() {
    ...
    install(Authentication) {
        // "Implement API key auth (TodolistAuth) for parameter name 'X-API-Key'."
        apiKeyAuth("TodolistAuth") {
