...
public class TodoListRESTful_Verticle extends AbstractVerticle {
    static final Logger LOGGER = LoggerFactory.getLogger(TodoListRESTful_Verticle.class);
    ...
    public void start(Promise<Void> startPromise) throws Exception {
      ...
      return server.listen()
          .onSuccess(server -> LOGGER.info("TodoListRESTful_Verticle started on port " + server.actualPort()));
      })
